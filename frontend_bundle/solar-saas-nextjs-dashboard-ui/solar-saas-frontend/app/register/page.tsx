  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md rounded-2xl bg-white border border-zinc-200 shadow-sm p-6">
        ...
        <p className="text-sm text-zinc-600 mt-1">Creates a new organization + admin user.</p>

        <div className="mt-5 space-y-3">
          <label className="block">
            <div className="text-xs font-medium text-zinc-600 mb-1">Organization</div>
            <input
          ...
          <button
            ...
            onClick={async () => {
              ...
              setLoading(true);
              try {
                const res = await api.register(org, email, password);
